...
//     _alignment =
//         Alignment(random.nextDouble() * 2 - 1.2, random.nextDouble() * 2 - 1);
...
//         Profile profile = _authController.profile.value;
//         profile.diamonds = profile.diamonds! +
...
//             int.parse(data['gift_diamonds'].toString());
//       }
//       // Update Broadcaster diamonds on Live Streaming
...
//         // Sender
//         int index1 = _livekitStreamingController.listActiveCall
//             .indexWhere((element) => element['uid'] == data['sender_uid']);
//         if (index1 > -1) {
//           dynamic activeCall =
...
//           int index2 = _livekitStreamingController.listActiveCall
//               .indexWhere((element) => element['uid'] == receiverId);
//           if (index2 > -1) {
//             dynamic activeCall =
//                 _livekitStreamingController.listActiveCall[index2];
//             activeCall['diamonds'] += int.parse(data['diamonds'].toString()) -
//                 int.parse(data['vat'].toString());

//             _livekitStreamingController.listActiveCall.removeAt(index2);
//             _livekitStreamingController.listActiveCall
//                 .insert(index2, activeCall);
//           }
//         }
//       }
...
//         // Request to Call
//         case 'call_request':
//           if (_livekitStreamingController.listRequestedCall
//                   .indexWhere((element) => element['uid'] == data['uid']) ==
//               -1) {
...
//           break;
//         case 'cancel_request':
//           _livekitStreamingController.listRequestedCall
...
//           break;
//         case 'controller':
//           int index = _livekitStreamingController.listActiveCall
//               .indexWhere((element) => element['uid'] == data['uid']);
//           if (index > -1) {
...
//                     ?.setMicrophoneEnabled(!data['muted']);
//               } catch (e) {
//                 //
//               }
...
//                 try {
//                   await _room!.localParticipant
//                       ?.setCameraEnabled(!data['video_disabled']);
//                 } catch (e) {
//                   //
//                 }
//               }
...
//               .setActiveCalls([...data['group_callers']]);
//           break;
//         case "participant_joined":
//           dynamic userJoinedData = data;
//           if (userJoinedData != null) {
//             if (widget.isBroadcaster &&
//                 _authController.profile.value.blocks!
//                     .contains(userJoinedData['uid'])) {
//               // Get Out participant
//               dynamic actionData = {
...
//               };
//               _livekitStreamingController.listUserJoinedAnimation
//                   .insert(0, userJoinedData);
...
//               fromLiveRoom: true,
//             );
//           } else if (_livekitStreamingController.viewers
//                   .indexWhere((element) => element['uid'] == data['uid']) <
//               0) {
...
//           // load all participants for newly connected user
//           if (data['uid'] != _myUid) {
//             _livekitStreamingController.viewers
//                 .removeWhere((element) => element['uid'] == data['uid']);
//             // load all participants for existing connected user
//             _livekitStreamingController.viewers.add(userJoinedData);
//             _useIsolateSortingUserJoined(
...
//                                               LiveRoomIsolationActions
//                                                   .useIsolateUpdateLiveRoom(
//                                                       submissionData:
//                                                           submissionData);
...
//                                                 width: widget.vVipOrVipPreference[
//                                                                 'vvip_or_vip_preference']
//                                                             [
//                                                             'vvip_or_vip_gif'] !=
//                                                         null
//                                                     ? 22
//                                                     : 28,
//                                                 height: widget.vVipOrVipPreference[
//                                                                 'vvip_or_vip_preference']
//                                                             [
//                                                             'vvip_or_vip_gif'] !=
//                                                         null
...
//                               readOnly: _livekitStreamingController
//                                       .isBroadcaster.value
//                                   ? false
//                                   : !_livekitStreamingController
//                                       .allowCommentAndEmojiSend.value,
...
//                             int randomNumber = _random
//                                 .nextInt(listEmojiLikeKeywordName.length);
...
//                                   .profile.value.vvip_or_vip_preference,
//                             });
//                           },
//                           child: Container(
//                             padding: const EdgeInsets.all(2.0),
...
//                             }
//                             int randomNumber = _random
//                                 .nextInt(listEmojiHeartKeywordName.length);
//                             Emoji? emoji = Emoji.byShortName(
...
//                             }
//                             int randomNumber = _random
//                                 .nextInt(listEmojiSmileKeywordName.length);
//                             Emoji? emoji = Emoji.byShortName(
...
//                             ),
//                             child: Text(
//                               Emoji.byShortName('smiling_face_with_3_hearts')!
//                                   .char,
//                               style: const TextStyle(
//                                 fontSize: 20,
//                               ),
...
//                             }
//                             int randomNumber = _random
//                                 .nextInt(listEmojiHaHaKeywordName.length);
//                             Emoji? emoji = Emoji.byShortName(
...
//                                     color: _livekitStreamingController
//                                             .allowCommentAndEmojiSend.value
//                                         ? Colors.green
//                                         : Colors.red,
//                                     size: 24.0,
...
//                                     .expandMediaController.value;
//                           },
//                           icon: !_livekitStreamingController
//                                   .expandMediaController.value
...
//                           minHeight: 32,
//                           minWidth: 32,
//                           iconColor: !_livekitStreamingController
//                                   .expandMediaController.value
//                               ? Colors.white70
//                               : Colors.orange,
...
//               preferredCodec: credential['codec'],
//               maxBitrate: credential['max_bitrate'],
//               maxFramerate: credential['max_framerate'],
//             ));
...
//             "profile_image": widget.profileImage,
//             "cover_image": null,
//             "vvip_or_vip_gif": widget.vVipOrVipPreference['vvip_or_vip_gif'],
...
//         return _initialRendererView();
//       }
//       // final views = participantTracks;
//       final views = _livekitStreamingController.listRenderView;

//       double activeCallerScreenWidth = _screenGlobalWidth * .33;
// // working 1
//       switch (_livekitStreamingController.listActiveCall.length) {
//         case 1:
//           return Obx(() {
//             return Container(
//               margin: EdgeInsets.zero,
//               alignment: Alignment.topRight,
//               child: _displayScreenView(
//                 view: views.firstWhereOrNull((element) =>
//                     element.participant.identity ==
//                     _livekitStreamingController.listActiveCall[0]['uid']
//                         .toString()),
//                 data: _livekitStreamingController.listActiveCall[0],
//                 width: _screenGlobalWidth,
//                 height: _screenGlobalHeight,
//               ),
//             );
//           });
//         case 2:
...
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[0],
//                         width: _screenGlobalWidth / 2,
//                         height: _screenGlobalHeight * .40,
//                       ),
//                       _displayScreenView(
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[1]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[1],
//                         width: _screenGlobalWidth / 2,
//                         height: _screenGlobalHeight * .40,
//                       ),
//                     ],
...
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[0],
//                         width: activeCallerScreenWidth * 1.5,
//                         height: _screenGlobalHeight * .30,
//                       ),
//                       _displayScreenView(
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
...
//                     view: views.firstWhereOrNull((element) =>
//                         element.participant.identity ==
//                         _livekitStreamingController.listActiveCall[2]['uid']
//                             .toString()),
//                     data: _livekitStreamingController.listActiveCall[2],
//                     width: activeCallerScreenWidth * 1.5,
//                     height: _screenGlobalHeight * .30,
//                   ),
//                 ],
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[3]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[3],
//                         width: activeCallerScreenWidth * 1.5,
//                         height: _screenGlobalHeight * .30,
//                       ),
//                     ],
...
//                         data: _livekitStreamingController.listActiveCall[0],
//                         serial: 'Host',
//                         width: activeCallerScreenWidth * 2),
//                     Column(
//                       mainAxisAlignment: MainAxisAlignment.start,
//                       crossAxisAlignment: CrossAxisAlignment.center,
//                       mainAxisSize: MainAxisSize.min,
...
//                             view: views.firstWhereOrNull((element) =>
//                                 element.participant.identity ==
//                                 _livekitStreamingController.listActiveCall[1]
//                                         ['uid']
//                                     .toString()),
//                             data: _livekitStreamingController.listActiveCall[1],
//                             serial: '2',
//                             width: activeCallerScreenWidth),
//                         _displayScreenView(
//                             view: views.firstWhereOrNull((element) =>
//                                 element.participant.identity ==
//                                 _livekitStreamingController.listActiveCall[2]
//                                         ['uid']
//                                     .toString()),
//                             data: _livekitStreamingController.listActiveCall[2],
//                             serial: '3',
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[4]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[4],
//                         serial: '5',
//                         width: activeCallerScreenWidth),
//                   ],
//                 ),
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[5]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[5],
//                         serial: '6',
//                         width: activeCallerScreenWidth),
//                   ],
//                 ),
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[6]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[6],
//                         serial: '7',
//                         width: activeCallerScreenWidth),
//                   ],
//                 ),
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[7]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[7],
//                         serial: '8',
//                         width: activeCallerScreenWidth),
//                   ],
//                 ),
...
//                         view: views.firstWhereOrNull((element) =>
//                             element.participant.identity ==
//                             _livekitStreamingController.listActiveCall[8]['uid']
//                                 .toString()),
//                         data: _livekitStreamingController.listActiveCall[8],
//                         serial: '9',
//                         width: activeCallerScreenWidth),
//                   ],
//                 ),
...
//               onTap: () {
//                 if (_livekitStreamingController.listActiveCall.length > 1) {
//                   if (data['uid'] != _myUid) {
//                     _livekitStreamingController.setSelectedGift(
//                         giftType: '', id: 0);
//                     _livekitStreamingController.setUserInteractTab(
...
//                 decoration: BoxDecoration(
//                   // color:  Colors.black,
//                   // gradient: _livekitStreamingController.listActiveCall.length >
//                   //                 1
...
//             ),
//           ),
//           // (!_livekitStreamingController.pkState.value && data['uid'].toString() != widget.channelName) ||
//           //         (_livekitStreamingController.pkState.value && _livekitStreamingController.listActivePK.length > 1)

//           // Bottom
//           _livekitStreamingController.listActiveCall.length > 1
//               ? Positioned(
//                   bottom: 4,
//                   left: 8,
//                   right: 8,
...
//                                       //   fontSize: 14,
//                                       // ),
//                                       // "${data['full_name'].length > ((!_livekitStreamingController.pkState.value && (_livekitStreamingController.listActiveCall.length > 4 || _livekitStreamingController.allowVideoCall.value)) ? 8 : 12) ? data['full_name'].substring(0, ((!_livekitStreamingController.pkState.value && (_livekitStreamingController.listActiveCall.length > 4 || _livekitStreamingController.allowVideoCall.value)) ? 8 : 12)) + '...' : data['full_name']}",
//                                       overflow: TextOverflow.ellipsis,
//                                       style: TextStyle(
//                                         color: Colors.white,
//                                         fontSize: (!_livekitStreamingController
//                                                     .pkState.value &&
//                                                 (_livekitStreamingController
//                                                             .listActiveCall
//                                                             .length >
...
//                         // color: Colors.white,
//                         color: Colors.red,
//                         size: _livekitStreamingController.pkState.value
//                             ? 16.0
//                             : 12.0,
//                       ),
//                     ),
...
//     return Container(
//       decoration: BoxDecoration(
//         border: view.participant.isSpeaking &&
//                 !view.isScreenShare &&
//                 view.participant.isMicrophoneEnabled()
//             ? Border.all(
//                 color: Colors.red.shade600,
...
//   Widget _initialRendererView() {
//     double activeCallerScreenWidth = _screenGlobalWidth * .33;

//     switch (_livekitStreamingController.listRenderView.length) {
//       case 1:
//         return _displayRendererScreen(
//           view: _livekitStreamingController.listRenderView[0],
//           width: _screenGlobalWidth,
//           height: _screenGlobalHeight,
//         );
//       case 2:
...
//               crossAxisAlignment: CrossAxisAlignment.center,
//               children: <Widget>[
//                 _displayRendererScreen(
//                   view: _livekitStreamingController.listRenderView[0],
//                   width: _screenGlobalWidth / 2,
//                   height: _screenGlobalHeight * .40,
//                 ),
//                 _displayRendererScreen(
//                   view: _livekitStreamingController.listRenderView[1],
//                   width: _screenGlobalWidth / 2,
//                   height: _screenGlobalHeight * .40,
//                 ),
//               ],
...
//               ),
//               _displayRendererScreen(
//                 view: _livekitStreamingController.listRenderView[2],
//                 width: activeCallerScreenWidth * 1.5,
//                 height: _screenGlobalHeight * .30,
//               ),
//             ],
...
//                   ),
//                   _displayRendererScreen(
//                     view: _livekitStreamingController.listRenderView[3],
//                     width: activeCallerScreenWidth * 1.5,
//                     height: _screenGlobalHeight * .30,
//                   ),
//                 ],
...
//                       width: activeCallerScreenWidth),
//                   _displayRendererScreen(
//                       view: _livekitStreamingController.listRenderView[4],
//                       width: activeCallerScreenWidth),
//                 ],
//               ),
//             ],
...
//                       width: activeCallerScreenWidth),
//                   _displayRendererScreen(
//                       view: _livekitStreamingController.listRenderView[5],
//                       width: activeCallerScreenWidth),
//                 ],
//               ),
//             ],
...
//                 children: <Widget>[
//                   _displayRendererScreen(
//                       view: _livekitStreamingController.listRenderView[6],
//                       width: activeCallerScreenWidth),
//                 ],
//               ),
//             ],
...
//                       width: activeCallerScreenWidth),
//                   _displayRendererScreen(
//                       view: _livekitStreamingController.listRenderView[7],
//                       width: activeCallerScreenWidth),
//                 ],
//               ),
//             ],
...
//                       width: activeCallerScreenWidth),
//                   _displayRendererScreen(
//                       view: _livekitStreamingController.listRenderView[8],
//                       width: activeCallerScreenWidth),
//                 ],
//               ),
//             ],
...
//                         Container(
//                           constraints: BoxConstraints(
//                               maxWidth: _screenGlobalWidth - 175),
//                           child: Text(
//                             '${data['full_name']}: ',
//                             overflow: TextOverflow.ellipsis,
//                             style: const TextStyle(
...
//                         Container(
//                           constraints: BoxConstraints(
//                               maxWidth: _screenGlobalWidth * .40),
//                           child: Text(
//                             '${data['full_name']}: ',
//                             overflow: TextOverflow.ellipsis,
//                             style: const TextStyle(
...
//                         ),
//                         Text(
//                           // 'sent ${data['emoji'] is Emoji ? data['emoji'].char : data['emoji']} x ${data['count'] ?? 0}',
...
//           _livekitStreamingController.viewers
//               .removeWhere((element) => element['uid'] == participantId);
//           _useIsolateSortingUserJoined(
//               listViewers: _livekitStreamingController.viewers.toList());
...
//     } else {
//       if (_livekitStreamingController.listActiveCall
//               .indexWhere((element) => element['uid'] == _myUid) !=
//           -1) {
...
//       // Checking blocks
//       if (_livekitStreamingController.liveStreamData.value['blocks'] != null &&
//           _livekitStreamingController.liveStreamData.value['blocks']
//               .contains(_myUid)) {
//         timer.cancel();
//         _closeEverything();
//         Get.defaultDialog(
...
//       if (!_livekitStreamingController.liveStreamData
//           .containsKey('created_datetime')) {
...
//                       dateTime: DateTime.parse(_livekitStreamingController
...
//         // Working emoji
//         _emojiItems.removeWhere((EmojiItem emojiItem) =>
//             (DateTime.parse(emojiItem.datetime!)
//                     .toLocal()
...
//                   Container(
//                     constraints:
//                         BoxConstraints(maxWidth: _screenGlobalWidth * .45),
//                     child: Text(
//                       '${data['full_name']}',
//                       overflow: TextOverflow.ellipsis,
//                       style: const TextStyle(
...
//               color: Colors.black38,
//               borderRadius: BorderRadius.circular(10),
//               border: data['vvip_or_vip_preference'] == null ||
...
//       {required List<dynamic> listViewers}) async {
