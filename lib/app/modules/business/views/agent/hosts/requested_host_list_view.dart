...
class RequestedHostListView extends StatefulWidget {
  const RequestedHostListView({super.key, this.agentUserId});
                        ...
                        rPrimaryTextField(
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              ...
                              if (_businessController
                                  .loadingHostRequestConfirmation
                                  .value) {
                                rShowSnackBar(
                                  context: context,
                                  title:
                              ...
                              try {
                                ...
                                if (uid > 0) {
                                  ...
                                  _businessController.tryToSearchHostRequest(
                                    userId: uid,
                                ...
                                child: InkWell(
                                  onTap: () {
                                    Get.defaultDialog(
                                      ...
                                      onConfirm: () {
                                        _businessController.tryToConfirmHostRequest(
                                          userId: _businessController
                                              .searchedHostRequestedData['profile']['user']['uid'],
                                          agentUserId: widget.agentUserId,
                                        );
                                        Get.close;
                                      },
                        ...
                        Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              dynamic hostRequestData =
                                  _businessController.hostRequestList[index];
                              return Container(
                                margin: const EdgeInsets.symmetric(vertical: 2),
                                padding: const EdgeInsets.symmetric(
                                  vertical: 8.0,
                                  ...
                                  onTap: () {
                                    Get.defaultDialog(
                                      ...
                                      onConfirm: () {
                                        _businessController.tryToConfirmHostRequest(
                                          userId:
                                              hostRequestData['profile']['user']['uid'],
                                          agentUserId: widget.agentUserId,
                                        );
                                        Get.close;
                                      },
